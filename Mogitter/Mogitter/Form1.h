...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// ToolMenu
			// 
			this->ToolMenu->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->mogi_makeMenuItem, 
				this->optionMenuItem});
			...
			// optionMenuItem
			// 
			this->optionMenuItem->Image = (cli::safe_cast<System::Drawing::Image^  >(resources->GetObject(L"optionMenuItem.Image")));
			this->optionMenuItem->Name = L"optionMenuItem";
			this->optionMenuItem->Size = System::Drawing::Size(227, 22);
			this->optionMenuItem->Text = L"オプション(&O)";
			// 
			// HelpMenu
			// 
